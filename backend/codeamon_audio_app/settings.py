"""
Django settings for codeamon_audio_app project.
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # Moved to top for better error handling
...
ROOT_URLCONF = 'codeamon_audio_app.urls'
...
WSGI_APPLICATION = 'codeamon_audio_app.wsgi.application'
